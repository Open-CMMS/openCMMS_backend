...
urlpatterns_equipment = [
    ...
    path(
        "equipments/<int:pk>/",
        views_equipment.equipment_detail,
...
urlpatterns_equipmenttype = [
    path(
        "equipmenttypes/",
        views_equipmentType.equipmenttype_list,
        name="equipmenttype-list",
    ),
    path(
        "equipmenttypes/<int:pk>/",
        views_equipmentType.equipmenttype_detail,
...
urlpatterns_fieldValue = [
    path(
        "fieldvalues_for_field/<int:pk>/",
        views_fieldValue.fieldValue_for_field,
        name="fieldvalues-on-all",
    )
]

urlpatterns_field = [path("fields/", views_field.field_list, name="field-list")]
...
urlpatterns_fieldObject = [
    ...
    path(
        "fieldobjects/<int:pk>/",
        views_fieldObject.fieldObject_detail,
        name="fieldObject-detail",
    ),
]
