...
urlpatterns_users = [
    ...
    path(
        "users/is_first_user",
        views_user.is_first_user_request,
        name="is_first_user_request",
    ),
    ...
    path(
        "users/<int:pk>/get_user_permissions",
        views_user.get_user_permissions,
...
url_patterns_teamtypes = [
    ...
    path(
        "teamtypes/<int:pk>/", views_teamtypes.teamtypes_detail, name="teamtypes-detail"
    ),
]
